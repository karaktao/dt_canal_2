...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        name: 'Profile',
        meta: { title: 'User Center', icon: 'user' }
      }
    ]
  },
  ...
  // },
  {
    ...
    component: Layout,
    name: 'Publish Demand',
    meta: { title: 'Publish', icon: 'user' },
    children: [
      {
        path: 'postCargo',
        name: 'PostCargo',
        component: () => import('@/views/logistics/PostCargo.vue'),
        meta: { title: 'Post Cargo', icon: 'user' }
      },
      {
        path: 'postVessel',
        name: 'PostVessel',
        component: () => import('@/views/logistics/PostVessel.vue'),
        meta: { title: 'Post Vessel', icon: 'user' }
      }
    ]
  },
  {
