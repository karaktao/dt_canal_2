...
const recordsByDepartureStart = computed(() => {
  return rawRecords.value
    .filter((item) => item.assignmentType === "vessel_to_cargo")
    .reduce(
      (groups, item) => {
...
function mapCapacityFields() {
  if (form.value.capacityUnit === "ton") {
    form.value.tonnageAvailable = form.value.capacityValue;
    form.value.containerAvailable = null;
    form.value.containerId = "";
  } else if (form.value.capacityUnit === "container") {
    form.value.containerAvailable = form.value.capacityValue;
    form.value.tonnageAvailable = null;
  }
}
        ...
        <el-card v-if="showForm" class="map-card form-panel" shadow="always">
          ...
          >
            ...
            <el-row :gutter="10">
              ...
              <el-row :gutter="10">
                <el-col :span="12">
                  <el-form-item label="Vessel Name" prop="vesselName" required>
                    <el-input v-model="form.vesselName" />
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="MMSI Number">
                    <el-input v-model="form.mmsiNumber" />
                  </el-form-item>
                </el-col>
              </el-row>
            ...
            <el-row :gutter="10">
              <el-col :span="12">
                <el-form-item label="Is Empty Vessel">
                  <el-switch v-model="form.isEmptyVessel" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="Available Cargo Type">
            ...
            <el-row :gutter="10">
              <el-col :span="12">
                <el-form-item label="Return Trip Available">
                  <el-switch v-model="form.isReturnTripAvailable" />
                </el-form-item>
              </el-col>
            </el-row>

            <!-- 行 8：返程补充（仅当返程开关开启时显示） -->
            <el-row v-if="form.isReturnTripAvailable" :gutter="10">
              <el-col :span="24">
                <el-form-item label="Return Availability Window">
                  <el-row :gutter="10">
                    <el-col :span="12">
                      <el-config-provider :locale="enLocale">
                        <el-date-picker
                          v-model="form.vesselAvailabilityStart"
                          type="datetime"
                          placeholder="Start"
                          style="width: 100%"
                        />
                    ...
                    <el-col :span="12">
                      <el-config-provider :locale="enLocale">
                        <el-date-picker
                          v-model="form.vesselAvailabilityEnd"
                          type="datetime"
                          placeholder="End"
                          style="width: 100%"
                        />
            ...
            <el-row v-if="form.isReturnTripAvailable" :gutter="10">
              <el-col :span="12">
                <el-form-item label="Return Destination">
                  <el-autocomplete
                    v-model="form.returnDestinationPort"
                    :fetch-suggestions="querySearchBerths"
                    placeholder="Enter port name"
                    @select="handleReturnDestinationPortSelect"
                  />
                </el-form-item>
              </el-col>
            </el-row>
          ...
          <el-collapse :style="{ marginTop: '-5px', marginBottom: '-10px' }">
            <el-collapse-item>
              ...
              <el-row :gutter="20">
                <el-col :span="24">
                  Capacity Available :
                  <span v-if="record.tonnageAvailable">
